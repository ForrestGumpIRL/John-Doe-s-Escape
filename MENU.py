...
class MainMenu(Menu):
    ...
    def __init__(self):
        ...
        self.logo = pygame.image.load(os.path.join('graphics', 'new logo.png')).convert_alpha()
...
class CreditsMenu(Menu):
    ...
    def __init__(self):
        ...
        self.maxwellsalmon = TEXT.Text(0,0, 'HakermanOfficial', SETTINGS.DARKGRAY, "DUGAFONT.ttf", 38)
        ...
        self.specialthanks = TEXT.Text(0,0, 'THANKS  TO  THE  PYGAME  COMMUNITY  FOR  HELP  AND NEVER GIVING THIS UP', SETTINGS.DARKGRAY, "DUGAFONT.ttf", 15)
        self.specialthanks.update_pos((SETTINGS.canvas_actual_width/2)-(self.specialthanks.layout.get_width()/2)+8, 380)

        self.and_you = TEXT.Text(0,0, 'SPECIAL  THANKS  TO  MAXWELLSALMON  FOR  HELPING  WITH  ALL  THE  TEXTURES  AND  ANIMATIONS!' , SETTINGS.RED, "DUGAFONT.ttf", 15)
        self.and_you.update_pos((SETTINGS.canvas_actual_width/3)-(self.and_you.layout.get_width()/3)+8, 410)
